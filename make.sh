go run exe/main.go -peg xml.peg -dumptree -testfile "/Users/quarnster/Library/Application Support/Sublime Text 3/Packages/c.tmbundle/Syntaxes/C.plist" -ignore "Spacing,Comment,EndTag,Tag,XmlFile" -notest
...
go run exe/main.go -peg plistxml.peg -dumptree -testfile "/Users/quarnster/Library/Application Support/Sublime Text 3/Packages/c.tmbundle/Syntaxes/C++.plist" -ignore "Spacing,KeyValuePair,KeyTag,StringTag,Value,Values,PlistFile,Plist"  -notest
